...
const OPTIONS: OptionEntry[] = [
  ...
  { flag: '--template <args...>', description: 'Key/value pairs that fill _flag directives in email.json. Requires --config-email. Example: --template msg_1 "Hello" msg_2 "World"', type: 'mixed', configurable: true },
  // Tool options
